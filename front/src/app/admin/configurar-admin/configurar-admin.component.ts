...
@Component({
  selector: 'app-configurar-admin',
  templateUrl: './configurar-admin.component.html',
  styleUrls: ['./configurar-admin.component.css'],
})
export class ConfigurarAdminComponent implements OnInit {
  constructor(
  ...
  updateUser(): void {
    Swal.fire({
      title: `¿Quieres actualizar el admin con estos datos?`,
      icon: 'warning',
